...
public class SADepartamentoImp implements SADepartamento {
	/** 
	* (non-Javadoc)
	* @see SADepartamento#consultarDepartamentoPorId(int id)
	* @generated "UML a JPA (com.ibm.xtools.transform.uml2.ejb3.java.jpa.internal.UML2JPATransform)"
	*/
	...
	*/
	...
	/** 
	* (non-Javadoc)
	* @see SADepartamento#bajaDepartamento(int id)
	* @generated "UML a JPA (com.ibm.xtools.transform.uml2.ejb3.java.jpa.internal.UML2JPATransform)"
	*/
	...
	/** 
	* (non-Javadoc)
	* @see SADepartamento#consultarDepartamentos()
	* @generated "UML a JPA (com.ibm.xtools.transform.uml2.ejb3.java.jpa.internal.UML2JPATransform)"
	*/
	...
	/** 
	* (non-Javadoc)
	* @see SADepartamento#modificarDepartamento(TDepartamento departamento)
	* @generated "UML a JPA (com.ibm.xtools.transform.uml2.ejb3.java.jpa.internal.UML2JPATransform)"
	*/
