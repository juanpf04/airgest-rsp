...
public class VistaModificarIdAerolinea extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Modificar Aerolínea");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.MODIFICAR_AEROLINEA_ID, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.MODIFICAR_AEROLINEA_ID, 0));
				}
			}
		});
