...
public class VistaConsultarAvionesPorAerolinea extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Consultar aviones por Aerolinea");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.CONSULTAR_AVIONES_POR_AEROLINEA, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.CONSULTAR_AVIONES_POR_AEROLINEA, 0));
				}
			}
		});
