...
public class VistaModificarIdAvion extends JFrame implements Observador{
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Modificar Avión");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.MODIFICAR_AVION_ID, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.MODIFICAR_AVION_ID, 0));
				}
			}
		});
