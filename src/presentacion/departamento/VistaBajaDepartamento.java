...
public class VistaBajaDepartamento extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Baja Departamento");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.BAJA_DEPARTAMENTO, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.VISTA_FALLO_BAJA_DEPARTAMENTO, 0));
				}
			}
