...
public class VistaConsultarAerolineasPorModelo extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Consultar Aerolíneas por Modelo");
		...
		JLabel etiquetaA = new JLabel("id Modelo: ");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try 
				{
					int idModelo = Integer.valueOf(textoA.getText());
					
					ctrl.accion(new Contexto(Evento.CONSULTAR_AEROLINEAS_POR_MODELO, idModelo));

				} catch (Exception ex) 
				{
					ctrl.accion(new Contexto(Evento.CONSULTAR_AEROLINEAS_POR_MODELO, 0));
				}
			}
		});
