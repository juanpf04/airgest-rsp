...
public class VistaModificarIdPersonal extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.MODIFICAR_PERSONAL_ID, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.MODIFICAR_PERSONAL_ID, 0));
				}
			}
		});
		...
		atras.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				dispose();
				controlador.accion(new Contexto(Evento.VISTA_MODIFICAR_PERSONAL, null));
			}
		});
