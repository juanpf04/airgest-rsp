...
public class VistaFalloVincularProveedorProducto extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel exito = new JLabel("Vinculación de Proveedor y Producto fallida! :(");
