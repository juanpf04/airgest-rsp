...
public class VistaMostrarProveedoresPorProducto extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Consultar Proveedores por Producto");
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.CONSULTAR_PROVEEDORES_POR_PRODUCTO, id));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.CONSULTAR_PROVEEDORES_POR_PRODUCTO, 0));
				}
			}
		});
