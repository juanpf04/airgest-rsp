...
public class VistaDesvincularProveedorProducto extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("Desvincular Proveedor");
		...
		etiquetaIdProveedor.setFont(new Font("Tahoma", Font.BOLD, 23));
		...
		etiquetaIdProducto.setFont(new Font("Tahoma", Font.BOLD, 23));
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					controlador.accion(new Contexto(Evento.DESVINCULAR_PROVEEDOR, parametros));
				} catch (NumberFormatException n) {
					controlador.accion(new Contexto(Evento.VISTA_FALLO_DESVINCULAR_PROVEEDOR));
				}
			}
