...
public class VistaError extends JFrame implements Observador {
	...
	public void actualizar(Object datos) {
		...
		JLabel titulo = new JLabel("AIRGEST RSP"); // titulo de la ventana en la
													// que estamos, apareceran
													// las funciones de modelo
		titulo.setBorder(new LineBorder(Color.BLACK, 2));

		titulo.setFont(new Font("Comic Sans", Font.BOLD, 30));
		titulo.setHorizontalAlignment(SwingConstants.CENTER); // ESTO ES LO QUE
																// LO CENTRA,
																// SWINGCONSTANTS
		...
		JButton modelo = new JButton("VOLVER");
		...
		modelo.setToolTipText("VUELVE A LA VISTA PRINCIPAL");
		botones.add(modelo);
